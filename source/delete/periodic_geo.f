      ...
      DO J=0,TNKY
        DO K=0,TNKZ_S
          DO I=0,NKX_S
            ...
            CF2(I,K,J)=I_RO_TAU*(-1.d0*C_COS*CU3(I,K,J)+CSIN*CU1(I,K,J))
...
C Read input file.
     ...
     &         STOP 'Wrong input data format input_chan'
      ...
      READ(11,*)
      READ(11,*) I_RO_TAU, PHI, GAMMA, G_TAU
      READ(11,*)
      READ(11,*) TRUCK, GUSTS
      DO N=1,N_TH
        READ(11,*)
