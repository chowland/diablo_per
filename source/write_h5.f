...
! Create the groups for each quantity (with attribute)
      ...
      call h5gcreate_f(file_id,'U2L',gid,error)
      call h5screate_f(H5S_SCALAR_F,tspace,error)
      call h5acreate_f(gid,'Samples',H5T_STD_I32LE,tspace,aid,error)
      call h5awrite_f(aid,H5T_NATIVE_INTEGER,0,adims,error)
      call h5aclose_f(aid,error)
      ...
      call h5gcreate_f(file_id,'U2S',gid,error)
      call h5screate_f(H5S_SCALAR_F,tspace,error)
      call h5acreate_f(gid,'Samples',H5T_STD_I32LE,tspace,aid,error)
      call h5awrite_f(aid,H5T_NATIVE_INTEGER,0,adims,error)
      call h5aclose_f(aid,error)
      ...
      call h5gcreate_f(file_id,'U3L',gid,error)
      call h5screate_f(H5S_SCALAR_F,tspace,error)
      call h5acreate_f(gid,'Samples',H5T_STD_I32LE,tspace,aid,error)
      call h5awrite_f(aid,H5T_NATIVE_INTEGER,0,adims,error)
      call h5aclose_f(aid,error)
      ...
      call h5gcreate_f(file_id,'U3S',gid,error)
      call h5screate_f(H5S_SCALAR_F,tspace,error)
      call h5acreate_f(gid,'Samples',H5T_STD_I32LE,tspace,aid,error)
      call h5awrite_f(aid,H5T_NATIVE_INTEGER,0,adims,error)
      call h5aclose_f(aid,error)
      ...
      call h5gcreate_f(file_id,'TH1L',gid,error)
      call h5screate_f(H5S_SCALAR_F,tspace,error)
      call h5acreate_f(gid,'Samples',H5T_STD_I32LE,tspace,aid,error)
      call h5awrite_f(aid,H5T_NATIVE_INTEGER,0,adims,error)
      call h5aclose_f(aid,error)
      ...
      call h5gcreate_f(file_id,'TH1S',gid,error)
      call h5screate_f(H5S_SCALAR_F,tspace,error)
      call h5acreate_f(gid,'Samples',H5T_STD_I32LE,tspace,aid,error)
      call h5awrite_f(aid,H5T_NATIVE_INTEGER,0,adims,error)
      call h5aclose_f(aid,error)
